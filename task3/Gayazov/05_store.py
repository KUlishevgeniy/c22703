...
s_goods = ['Лампа', 'Стол', 'Диван', 'Стул']
for k in range(len(s_goods)):
    i = store[goods[s_goods[k]]]
    kolvo = 0
    price = 0
    for j in range(len(i)):
            kolvo += i[j]['quantity']
            price += i[j]['quantity']*i[j]['price']
    print(s_goods[k],"-", kolvo, "шт., стоимость", price, "руб")
